...
export default async function NewFieldVideoPage({ searchParams }: { searchParams: Promise<DashboardSearchParams> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <FieldVideoForm siteId={site.id} query={query} item={null} />
    </div>
  );
}
